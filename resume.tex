...
\usepackage[letter,margin=0.8in]{geometry}
\usepackage{mdwlist}
...
\begin{itemize}
	...
	\headerrow
		...
		{\emph{2015 -- presnt}}
	\begin{itemize*}
		\item Preserving LEP documentation, computing, and data
		\item Assessing WLCG as digital archives by RDA and ISO standards
    \item Built the global DPHEP \href{http://dphep.web.cern.ch}{portal}
    ...
    \item Deployed of elastic batch computing resources for High Energy
      Physics experiments
    \item Included Nimbus, OpenStack, Amazon, and Google Compute Engine
	...
	\headerrow
		...
		{\emph{2006 -- 2013}}
	\begin{itemize*}
		\item Analysed early data employing profile likelihood and hybrid approaches
		\item Developed jet calibration procedures for the ATLAS experiment
		\item Developed software to monitor the liquid argon calorimeter
		\item Operation of the detector at CERN
	\end{itemize*}
\end{itemize}
...
% 	Sciences.
% 	\item[2000-2003]
% 	Achievement Scholarship, Saint Mary’s University.
% \end{itemize}
