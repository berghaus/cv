...
\begin{tabu} to \textwidth{r p{6.5cm} r p{6.5cm}}
  ...
  \rule{0pt}{4ex}
	...
	\rule{0pt}{4ex}
	git    & Collaborative code development     & Preservation & Design
 and assessment of Open Archival Information Systems \\
	\rule{0pt}{4ex}
	Clouds & Usage of OpenStack, Amazon EC2, GCE and Nimbus & \LaTeX & Writing scientific
