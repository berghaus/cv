...
\begin{itemize}
	...
	\headerrow
		...
		{\emph{2006 -- 2013}}
	\begin{itemize*}
		\item Statistical analysis of ATLAS data employing Monte Carlo simulation methods
		\item Development of jet calibration procedures for the reconstruction of ATLAS data
		\item Development of software to monitor the liquid argon calorimeter
		\item Operation of the ATLAS detector at CERN
	\end{itemize*}
\end{itemize}
...
\begin{itemize}
	\item[2015] \emph{Training on ISO 16363}, {CERN}, Genève, \textsc{Suisse}\\
	{\small Audit and certification of trustworthy digital repositories}
	\item[2015] \emph{Language Training}, {CERN}, Genève, \textsc{Suisse}\\
	{\small French A1 \& A2}
