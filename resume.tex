...
\begin{itemize}
    ...
    \item Built the \href{http://cern.ch/dphep}{website} of the collaboration for data preservation in high energy physics
		...
		\item Established a workflow for users to deposit and retrieve data using the CERN storage infrastructure
	\end{itemize*}
    ...
    \item Included OpenStack, Amazon Web Services, and Google Compute Engine in the computing systems for the ATLAS and Belle II experiments
	\end{itemize*}
